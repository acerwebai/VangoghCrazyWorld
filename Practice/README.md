...
Because the method of VGG19 network is resize style image to 256x256, we need revise style image to closed to 256x256. Then we can get more close style when transfer style to target contents. for example.
